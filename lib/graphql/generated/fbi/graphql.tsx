...
export type WorkTeaserFragment = {
  __typename?: "Work"
  workId: string
...
export type SearchFacetsQuery = {
  ...
  search: {
    ...
    facets: Array<{
      __typename?: "FacetResult"
      name: string
      values: Array<{ __typename?: "FacetValue"; key: string; term: string; score?: number | null }>
    }>
  }
}
...
useSearchWithPaginationQuery.getKey = (variables: SearchWithPaginationQueryVariables) => [
...
>(
  variables: SearchWithPaginationQueryVariables,
  options?: Omit<UseSuspenseQueryOptions<SearchWithPaginationQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseSuspenseQueryOptions<SearchWithPaginationQuery, TError, TData>["queryKey"]
  }
) => {
...
useSuspenseSearchWithPaginationQuery.getKey = (variables: SearchWithPaginationQueryVariables) => [
  "searchWithPaginationSuspense",
  variables,
]
...
useSearchWithPaginationQuery.fetcher = (
  ...
  fetchData<SearchWithPaginationQuery, SearchWithPaginationQueryVariables>(
    SearchWithPaginationDocument,
    variables,
    options
  )
...
export const useSearchFacetsQuery = <TData = SearchFacetsQuery, TError = unknown>(
  variables: SearchFacetsQueryVariables,
  options?: Omit<UseQueryOptions<SearchFacetsQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<SearchFacetsQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<SearchFacetsQuery, TError, TData>({
    queryKey: ["searchFacets", variables],
    queryFn: fetchData<SearchFacetsQuery, SearchFacetsQueryVariables>(
      SearchFacetsDocument,
      variables
    ),
    ...options,
  })
...
export const useSuspenseSearchFacetsQuery = <TData = SearchFacetsQuery, TError = unknown>(
  variables: SearchFacetsQueryVariables,
  options?: Omit<UseSuspenseQueryOptions<SearchFacetsQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseSuspenseQueryOptions<SearchFacetsQuery, TError, TData>["queryKey"]
  }
) => {
...
useSuspenseSearchFacetsQuery.getKey = (variables: SearchFacetsQueryVariables) => [
  "searchFacetsSuspense",
  variables,
]
...
useSearchFacetsQuery.fetcher = (
  ...
  fetchData<SearchFacetsQuery, SearchFacetsQueryVariables>(SearchFacetsDocument, variables, options)
