...
useSearchWithPaginationQuery.getKey = (
  variables: SearchWithPaginationQueryVariables
...
>(
  variables: SearchWithPaginationQueryVariables,
  options?: Omit<
    UseSuspenseQueryOptions<SearchWithPaginationQuery, TError, TData>,
    'queryKey'
  > & {
...
useSuspenseSearchWithPaginationQuery.getKey = (
  variables: SearchWithPaginationQueryVariables
) => ['searchWithPaginationSuspense', variables]
