 ...
 */
export const getCoverCollection = (params: GetCoverCollectionParams, signal?: AbortSignal) => {
  return fetcher<Cover[]>({ url: `/api/v2/covers`, method: "GET", params, signal })
}

export const getGetCoverCollectionQueryKey = (params: GetCoverCollectionParams) => {
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCoverCollection>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetCoverCollectionQueryKey(params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getCoverCollection>>> = ({ signal }) =>
    getCoverCollection(params, signal)
...
>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCoverCollection>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof getCoverCollection>>, TError, TData>,
        "initialData"
      >
  }
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getCoverCollection>>, TError, TData>
    > &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof getCoverCollection>>, TError, TData>,
        "initialData"
      >
  }
