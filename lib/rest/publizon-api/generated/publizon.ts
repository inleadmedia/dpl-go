...
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getV1UserCardnumberFriendly>>, TError, TData>
  >
}) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1UserCardnumberFriendlyQueryKey()

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1UserCardnumberFriendly>>> = ({
    signal,
  }) => getV1UserCardnumberFriendly(signal)
...
export const getV1UserChecklist = (signal?: AbortSignal) => {
  return fetcher<ChecklistResult>({ url: `/v1/user/checklist`, method: "GET", signal })
}
...
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserChecklist>>, TError, TData>>
}) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1UserChecklistQueryKey()

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1UserChecklist>>> = ({ signal }) =>
    getV1UserChecklist(signal)
...
>(options: {
  query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserChecklist>>, TError, TData>> &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserChecklist>>, TError, TData>,
      "initialData"
    >
}): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1UserChecklist<
...
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserChecklist>>, TError, TData>> &
    Pick<
      UndefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserChecklist>>, TError, TData>,
      "initialData"
    >
}): UseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1UserChecklist<
...
export const postV1UserChecklistIdentifier = (identifier: string) => {
  return fetcher<ApiResult>({ url: `/v1/user/checklist/${identifier}`, method: "POST" })
}
...
>(options?: {
  ...
  TContext
> => {
  const mutationOptions = getPostV1UserChecklistIdentifierMutationOptions(options)
...
export const deleteV1UserChecklistIdentifier = (identifier: string) => {
  return fetcher<ApiResult>({ url: `/v1/user/checklist/${identifier}`, method: "DELETE" })
}
...
>(options?: {
  ...
  TContext
> => {
  const mutationOptions = getDeleteV1UserChecklistIdentifierMutationOptions(options)

  return useMutation(mutationOptions)
}

export const getV1LibraryProfile = (signal?: AbortSignal) => {
  return fetcher<LibraryProfile>({ url: `/v1/library/profile`, method: "GET", signal })
}
...
export const getGetV1LibraryProfileQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1LibraryProfile>>, TError, TData>>
}) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1LibraryProfileQueryKey()

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1LibraryProfile>>> = ({ signal }) =>
    getV1LibraryProfile(signal)
...
>(options: {
  query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1LibraryProfile>>, TError, TData>> &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof getV1LibraryProfile>>, TError, TData>,
      "initialData"
    >
}): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1LibraryProfile<
...
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1LibraryProfile>>, TError, TData>> &
    Pick<
      UndefinedInitialDataOptions<Awaited<ReturnType<typeof getV1LibraryProfile>>, TError, TData>,
      "initialData"
    >
}): UseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1LibraryProfile<
 ...
 */
export const getV1UserLoans = (params?: GetV1UserLoansParams, signal?: AbortSignal) => {
  return fetcher<LoanListResult>({ url: `/v1/user/loans`, method: "GET", params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserLoans>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1UserLoans>>> = ({ signal }) =>
...
export type GetV1UserLoansQueryResult = NonNullable<Awaited<ReturnType<typeof getV1UserLoans>>>
...
>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserLoans>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserLoans>>, TError, TData>,
        "initialData"
      >
  }
): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey }
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserLoans>>, TError, TData>> &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserLoans>>, TError, TData>,
        "initialData"
      >
  }
): UseQueryResult<TData, TError> & { queryKey: QueryKey }
 ...
 */
export const getV1UserLoansIdentifier = (identifier: string, signal?: AbortSignal) => {
  return fetcher<LoanResult>({ url: `/v1/user/loans/${identifier}`, method: "GET", signal })
}
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getV1UserLoansIdentifier>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1UserLoansIdentifierQueryKey(identifier)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1UserLoansIdentifier>>> = ({
    signal,
  }) => getV1UserLoansIdentifier(identifier, signal)
...
>(
  ...
  const queryOptions = getGetV1UserLoansIdentifierQueryOptions(identifier, options)
...
export const postV1UserLoansIdentifier = (
  ...
  return fetcher<CreateLoanResult>({ url: `/v1/user/loans/${identifier}`, method: "POST", params })
}
 ...
 */
export const getV1LoanstatusIdentifier = (identifier: string, signal?: AbortSignal) => {
  return fetcher<LoanStatusResult>({ url: `/v1/loanstatus/${identifier}`, method: "GET", signal })
}
...
>(
  ...
  queryOptions?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getV1LoanstatusIdentifier>>, TError, TData>
  >
) => {
  const queryKey = queryOptions?.queryKey ?? getGetV1LoanstatusIdentifierQueryKey(identifier)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1LoanstatusIdentifier>>> = ({
    signal,
  }) => getV1LoanstatusIdentifier(identifier, signal)
...
>(
  ...
  const options = getGetV1LoanstatusIdentifierQueryOptions(identifier, queryOptions)
 ...
 * @summary Get loan status of all products.
 */
export const usePostV1Loanstatus = <TError = ErrorType<unknown>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postV1Loanstatus>>,
    TError,
    { data: BodyType<string[]> },
 ...
 */
export const getV1ProductsIdentifier = (identifier: string, signal?: AbortSignal) => {
  return fetcher<ProductResult>({ url: `/v1/products/${identifier}`, method: "GET", signal })
}
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getV1ProductsIdentifier>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1ProductsIdentifierQueryKey(identifier)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1ProductsIdentifier>>> = ({
    signal,
  }) => getV1ProductsIdentifier(identifier, signal)
...
>(
  ...
  const queryOptions = getGetV1ProductsIdentifierQueryOptions(identifier, options)
...
export const getV1Products = (signal?: AbortSignal) => {
  return fetcher<ProductListResult>({ url: `/v1/products`, method: "GET", signal })
}
...
export const getGetV1ProductsQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1Products>>, TError, TData>>
}) => {
  const { query: queryOptions } = options ?? {}
...
>(options: {
  query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1Products>>, TError, TData>> &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof getV1Products>>, TError, TData>,
      "initialData"
    >
}): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1Products<
...
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1Products>>, TError, TData>> &
    Pick<
      UndefinedInitialDataOptions<Awaited<ReturnType<typeof getV1Products>>, TError, TData>,
      "initialData"
    >
}): UseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1Products<
...
export const getV1UserReservations = (signal?: AbortSignal) => {
  return fetcher<ReservationListResult>({ url: `/v1/user/reservations`, method: "GET", signal })
}
...
export const getGetV1UserReservationsQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1UserReservations>>, TError, TData>>
}) => {
  const { query: queryOptions } = options ?? {}

  const queryKey = queryOptions?.queryKey ?? getGetV1UserReservationsQueryKey()

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getV1UserReservations>>> = ({ signal }) =>
    getV1UserReservations(signal)
...
>(options: {
  query: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getV1UserReservations>>, TError, TData>
  > &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserReservations>>, TError, TData>,
      "initialData"
    >
}): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1UserReservations<
...
>(options?: {
  ...
  > &
    Pick<
      UndefinedInitialDataOptions<Awaited<ReturnType<typeof getV1UserReservations>>, TError, TData>,
      "initialData"
    >
}): UseQueryResult<TData, TError> & { queryKey: QueryKey }
export function useGetV1UserReservations<
...
export type PostV1UserReservationsIdentifierMutationResult = NonNullable<
  Awaited<ReturnType<typeof postV1UserReservationsIdentifier>>
>
export type PostV1UserReservationsIdentifierMutationBody = BodyType<ReservationInput>
...
>(options?: {
  ...
  TContext
> => {
  const mutationOptions = getPostV1UserReservationsIdentifierMutationOptions(options)
...
export type PatchV1UserReservationsIdentifierMutationResult = NonNullable<
  Awaited<ReturnType<typeof patchV1UserReservationsIdentifier>>
>
export type PatchV1UserReservationsIdentifierMutationBody = BodyType<ReservationInput>
...
>(options?: {
  ...
  TContext
> => {
  const mutationOptions = getPatchV1UserReservationsIdentifierMutationOptions(options)
...
export const deleteV1UserReservationsIdentifier = (identifier: string) => {
  return fetcher<ApiResult>({ url: `/v1/user/reservations/${identifier}`, method: "DELETE" })
}
...
export type DeleteV1UserReservationsIdentifierMutationError = ErrorType<unknown>
...
>(options?: {
  ...
  TContext
> => {
  const mutationOptions = getDeleteV1UserReservationsIdentifierMutationOptions(options)
