...
export const VideoBundleSkeleton = () => {
  return (
    <div className="bg-background-skeleton">
      <div className="content-container">
        <div className="gap-paragraph-spacing-inner w-full py-4 text-center md:py-12 lg:py-16">
          <div className="bg-background mr-auto mb-4 ml-auto block h-10 w-36 animate-pulse rounded-full md:mb-10 lg:w-72" />
          <div className="flex w-full flex-col items-start gap-11 lg:flex-row lg:gap-0">
            <div className="rounded-base bg-background relative aspect-16/9 w-full animate-pulse overflow-hidden lg:w-[75%]" />
            <div
              ...
              <div
                className="bg-background rounded-base relative aspect-4/9 h-[250px] w-[177px] animate-pulse md:aspect-3/5
                  md:w-[300px] lg:h-[450px]"
              />
