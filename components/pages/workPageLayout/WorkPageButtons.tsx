    ...
    <>
      {isEbook(selectedManifestation) && (
        <>
          <Button
            ariaLabel="Prøv ebog"
            size={"default"}
            className="mb-grid-gap-half w-full lg:max-w-80"
            asChild
            disabled={!!identifier}>
          ...
          <Button ariaLabel="Lån/reserver/læse ebog" className="w-full lg:max-w-80">
            Not done yet
          </Button>
        </>
      )}
      ...
      {isAudioBook(selectedManifestation) && (
        <>
          ...
          <Button ariaLabel="Lån/reserver/læse lydbog" className="w-full lg:max-w-80">
            Not done yet
          </Button>
        </>
      )}
